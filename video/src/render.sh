...
ffmpeg -hide_banner -loglevel error -y \
  ...
  -filter_complex "[0:a]volume=0.055,lowpass=f=420,afade=t=out:st=0.16:d=0.26,adelay=280|280[intro0];[1:a]volume=0.07,afade=t=out:st=0.08:d=0.1,adelay=1080|1080[intro1];[2:a]volume=0.16,afade=t=out:st=0.04:d=0.05,adelay=21900|21900[a0];[3:a]volume=0.07,afade=t=out:st=0.08:d=0.08,adelay=28400|28400[a1];[4:a]volume=0.07,afade=t=out:st=0.08:d=0.08,adelay=30000|30000[a2];[5:a]volume=0.07,afade=t=out:st=0.08:d=0.08,adelay=31700|31700[a3];[6:a]volume=0.07,afade=t=out:st=0.08:d=0.08,adelay=33300|33300[a4];[7:a]volume=0.08,afade=t=out:st=0.2:d=0.35,adelay=36000|36000[a5];[8:a]volume=0.045,afade=t=out:st=0.2:d=0.35,adelay=36000|36000[a6];[9:a]volume=0.12,afade=t=out:st=0.12:d=0.18,adelay=65700|65700[a7];[10:a]volume=0.14,afade=t=out:st=0.08:d=0.12,adelay=70500|70500[a8];[11:a]volume=0.035,highpass=f=500,afade=t=out:st=0.15:d=0.2,adelay=82000|82000[a9];[intro0][intro1][a0][a1][a2][a3][a4][a5][a6][a7][a8][a9]amix=inputs=12:duration=longest,apad=pad_dur=98" \
...
ffmpeg -hide_banner -loglevel error -y \
  ...
  -filter_complex "[1:a]adelay=2000|2000,apad=pad_dur=3[voice];[2:a]volume=.72[bed];[3:a]volume=.82[fx];[voice][bed][fx]amix=inputs=3:duration=longest:dropout_transition=2,loudnorm=I=-14:TP=-1.0:LRA=8[mix]" \
...
ffmpeg -hide_banner -loglevel error -y \
  -itsoffset 2 -i "$AUDIO/voice-neural-v3.srt" \
